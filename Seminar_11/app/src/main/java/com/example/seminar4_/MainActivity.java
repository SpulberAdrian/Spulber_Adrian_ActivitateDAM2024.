...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button butonListaImagini = findViewById(R.id.butonImagini);
        butonListaImagini.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ActivitateImagini.class);
                startActivity(intent);
            }
        });

        Button butonJson = findViewById(R.id.JsonButon);
        butonJson.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Afisare_Json.class);
                startActivity(intent);
            }
        });

        Button butonFavorite = findViewById(R.id.ButonFavorite);
        butonFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(getApplicationContext() , Afisare_Favorite.class);
                startActivity(it);
            }
        });
    }
