...
//        });
        ...
        lw.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                final String KEY_FAVORITE = "Autocar_favorit";
                Autocar autocarSelectat = autocare.get(i);
                SharedPreferences sharedPreferences = getSharedPreferences("AutocarelePreferate", MODE_PRIVATE);
                SharedPreferences.Editor myEdit = sharedPreferences.edit();

                Set<String> favoriteSet = sharedPreferences.getStringSet(KEY_FAVORITE, new HashSet<>());
                favoriteSet.add(autocarSelectat.toString());
                myEdit.putStringSet(KEY_FAVORITE, favoriteSet);
//                myEdit.putString("Autocar preferat" ,autocare.get(i).toString());
//                myEdit.putInt("Locuri", autocare.get(i).getNrLocuri());
                myEdit.apply();

                Log.d("onItemLongClick", "Autocar adaugat la favorite" + autocarSelectat.toString());
